...
print(*car_data.items(), sep='\n')
search_criteria = (2017, 1.6, 36000)
cars_by_criteria = []
print('====================================Cars by criteria====================================')
year, volume, price = search_criteria
for car, data in car_data.items():
    car_color, car_year, car_volume, car_type, car_price = data
    if car_year >= year and car_volume >= volume and car_price <= price:
        cars_by_criteria.append((car, data))
        print(car, data)
print('====================================Sorted cars by criteria==============================')
sorted_cars = sorted(cars_by_criteria, key=lambda x: x[1][4])
print(*sorted_cars[:5], sep='\n')
